...
public interface KeyboardListener {
    ...
    /**
     * Translates the Braille dots to text without committing it to the input
     * connection.
     * 
     * @param dots
     *            The Braille dots.
    ...
    /**
     * Submit the text by performing the editor action (e.g. IME_ACTION_SEND)
     * or by sending a newline character if no action is specified.
     * 
     * @return true if an editor action was performed, false if fallback (newline) was used.
     */
    boolean submitText();
}
