...
public enum Swipe {
    ...
    HOLD_6_SWIPE_1_LEFT(hold(6, 1, Direction.LEFT), KeyboardAction.MOVE_TO_END),
    HOLD_6_SWIPE_1_RIGHT(hold(6, 1, Direction.RIGHT), KeyboardAction.MOVE_TO_START),
    ...
    HOLD_6_SWIPE_2_LEFT(hold(6, 2, Direction.LEFT), KeyboardAction.MOVE_TO_END),
    HOLD_6_SWIPE_2_RIGHT(hold(6, 2, Direction.RIGHT), KeyboardAction.MOVE_TO_START),
    HOLD_6_SWIPE_2_UP(hold(6, 2, Direction.UP), KeyboardAction.READ_ALL),
    HOLD_6_SWIPE_2_DOWN(hold(6, 2, Direction.DOWN),
            KeyboardAction.TOGGLE_PASSWORD_ECHO),
    HOLD_6_SWIPE_3_LEFT(hold(6, 3, Direction.LEFT), KeyboardAction.MOVE_TO_END),
    HOLD_6_SWIPE_3_RIGHT(hold(6, 3, Direction.RIGHT), KeyboardAction.MOVE_TO_START),
